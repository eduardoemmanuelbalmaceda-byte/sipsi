...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.5rem; flex-wrap:wrap; gap:0.75rem;">
    <div>
        ...
        <p class="page-header-sub">Resumen general del sistema — <?php echo e(now()->format('d/m/Y')); ?></p>
    </div>
    <a href="<?php echo e(route('oficios.create')); ?>" class="btn btn-primary" style="display:flex;align-items:center;gap:0.4rem;">
...
<div class="kpi-grid">
    <div class="kpi-card total">
        ...
        <div class="kpi-value"><?php echo e($totalOficios); ?></div>
    ...
    <div class="kpi-card pend">
        ...
        <div class="kpi-value"><?php echo e($pendientes); ?></div>
    ...
    <div class="kpi-card curso">
        ...
        <div class="kpi-value"><?php echo e($enCurso); ?></div>
    ...
    <div class="kpi-card cerrado">
        ...
        <div class="kpi-value"><?php echo e($cerrados); ?></div>
    ...
    <div class="kpi-card pac">
        ...
        <div class="kpi-value"><?php echo e($totalPacientes); ?></div>
    ...
    <div class="kpi-card prof">
        ...
        <div class="kpi-value"><?php echo e($totalProfesionales); ?></div>
        ...
        <div class="donut-wrap">
            ...
            <div class="donut-legend">
                <div class="legend-item">
                    ...
                    Pendientes <strong style="margin-left:4px;"><?php echo e($pendientes); ?></strong>
                </div>
                <div class="legend-item">
                    <div class="legend-dot" style="background:#6b5fb5;"></div>
                    En curso <strong style="margin-left:4px;"><?php echo e($enCurso); ?></strong>
                </div>
                <div class="legend-item">
                    <div class="legend-dot" style="background:#5a9e7a;"></div>
                    Cerrados <strong style="margin-left:4px;"><?php echo e($cerrados); ?></strong>
                </div>
            </div>
        </div>
    </div>
...
<div class="dash-grid three">
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <a href="<?php echo e(route('oficios.index')); ?>" class="panel-link">Ver todos</a>
        </div>
        <div class="panel-body">
            <?php if($turnosProximos->isEmpty()): ?>
            ...
            <?php else: ?>
                <ul class="mini-list">
                    ...
                    <li>
                        ...
                        <div class="mini-main">
                            <div class="mini-name">
                                <?php echo e($turno->oficio->paciente->apellido); ?>, <?php echo e($turno->oficio->paciente->nombre); ?>

                            </div>
                            <div class="mini-sub">
                                <?php echo e(\Carbon\Carbon::parse($turno->fecha_turno)->format('d/m/Y')); ?>

                                <?php echo e(substr($turno->hora, 0, 5)); ?>hs
                                · <?php echo e($turno->profesional->apellido); ?>

                            </div>
                        </div>
                        <a href="<?php echo e(route('oficios.show', $turno->oficio_id)); ?>" class="mini-badge curso">Ver</a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php endif; ?>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <?php if($oficiosRecientes->isEmpty()): ?>
                <div class="empty-state">Sin oficios registrados</div>
            <?php else: ?>
                <ul class="mini-list">
                    <?php $__currentLoopData = $oficiosRecientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oficio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <div class="mini-dot <?php echo e($oficio->estado == 'cerrado' ? 'cerrado' : ($oficio->estado == 'en_curso' ? 'curso' : 'pend')); ?>"></div>
                        <div class="mini-main">
                            <div class="mini-name">Nº <?php echo e($oficio->numero_oficio); ?> — <?php echo e($oficio->paciente->apellido); ?></div>
                            <div class="mini-sub"><?php echo e($oficio->juzgado->nombre); ?> · <?php echo e(\Carbon\Carbon::parse($oficio->fecha_recepcion)->format('d/m/Y')); ?></div>
                        </div>
                        <span class="mini-badge <?php echo e($oficio->estado == 'cerrado' ? 'cerrado' : ($oficio->estado == 'en_curso' ? 'curso' : 'pend')); ?>">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <?php if($informesPendientesEnvio->isEmpty()): ?>
            ...
            <?php else: ?>
                <ul class="mini-list">
                    <?php $__currentLoopData = $informesPendientesEnvio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <div class="mini-dot pend"></div>
                        <div class="mini-main">
                            <div class="mini-name"><?php echo e($informe->oficio->paciente->apellido); ?>, <?php echo e($informe->oficio->paciente->nombre); ?></div>
                            <div class="mini-sub"><?php echo e($informe->oficio->juzgado->nombre); ?> · <?php echo e(\Carbon\Carbon::parse($informe->fecha_informe)->format('d/m/Y')); ?></div>
                        </div>
                        <a href="<?php echo e(route('informes.edit', $informe)); ?>" class="mini-badge alerta">Pendiente</a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            <?php endif; ?>
...
(function() {
    ...
    const total = <?php echo e($totalOficios); ?>;
    const chartDonut = new Chart(ctxDonut, {
        type: 'doughnut',
        data: {
            labels: ['Pendientes', 'En curso', 'Cerrados'],
            datasets: [{
                data: [<?php echo e($pendientes); ?>, <?php echo e($enCurso); ?>, <?php echo e($cerrados); ?>],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KINGS OF PC\Herd\sipsi\resources\views/dashboard.blade.php ENDPATH**/ ?>