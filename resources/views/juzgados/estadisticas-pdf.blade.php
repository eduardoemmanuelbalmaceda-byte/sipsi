...
<body>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <td>TOTAL</td>
                <td class="right">{{ $totalGeneral }}</td>
            </tr>
        </tfoot>
    </table>
    ...
    <div class="chart">
        <div class="chart-title">Oficios Judiciales — {{ $periodo }}</div>
        <img src="{{ $chartImg }}" style="max-width:460px; height:auto;">
    </div>
    @endif

    <div class="footer">Generado el {{ now()->format('d/m/Y H:i') }} — SIPSI Psiquiatría Hospitalaria</div>
</body>
</html>
